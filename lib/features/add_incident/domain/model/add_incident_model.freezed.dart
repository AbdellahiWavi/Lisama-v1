...
part of 'add_incident_model.dart';
...
/// @nodoc
mixin _$AddIncidentModel {

 String? get decrireAction; String? get url; String? get county; UserLocation get userLocation; TypeCas get typeCas; Degree get degree; Client get client; bool get isAddingIncidentSuccess;
/// Create a copy of AddIncidentModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$AddIncidentModelCopyWith<AddIncidentModel> get copyWith => _$AddIncidentModelCopyWithImpl<AddIncidentModel>(this as AddIncidentModel, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AddIncidentModel&&(identical(other.decrireAction, decrireAction) || other.decrireAction == decrireAction)&&(identical(other.url, url) || other.url == url)&&(identical(other.county, county) || other.county == county)&&(identical(other.userLocation, userLocation) || other.userLocation == userLocation)&&(identical(other.typeCas, typeCas) || other.typeCas == typeCas)&&(identical(other.degree, degree) || other.degree == degree)&&(identical(other.client, client) || other.client == client)&&(identical(other.isAddingIncidentSuccess, isAddingIncidentSuccess) || other.isAddingIncidentSuccess == isAddingIncidentSuccess));
}


@override
int get hashCode => Object.hash(runtimeType,decrireAction,url,county,userLocation,typeCas,degree,client,isAddingIncidentSuccess);

@override
String toString() {
  return 'AddIncidentModel(decrireAction: $decrireAction, url: $url, county: $county, userLocation: $userLocation, typeCas: $typeCas, degree: $degree, client: $client, isAddingIncidentSuccess: $isAddingIncidentSuccess)';
}
...
/// @nodoc
abstract mixin class $AddIncidentModelCopyWith<$Res>  {
  factory $AddIncidentModelCopyWith(AddIncidentModel value, $Res Function(AddIncidentModel) _then) = _$AddIncidentModelCopyWithImpl;
@useResult
$Res call({
 String? decrireAction, String? url, String? county, UserLocation userLocation, TypeCas typeCas, Degree degree, Client client, bool isAddingIncidentSuccess
});
...
/// @nodoc
class _$AddIncidentModelCopyWithImpl<$Res>
    implements $AddIncidentModelCopyWith<$Res> {
  _$AddIncidentModelCopyWithImpl(this._self, this._then);

  final AddIncidentModel _self;
  final $Res Function(AddIncidentModel) _then;

/// Create a copy of AddIncidentModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? decrireAction = freezed,Object? url = freezed,Object? county = freezed,Object? userLocation = null,Object? typeCas = null,Object? degree = null,Object? client = null,Object? isAddingIncidentSuccess = null,}) {
...
as Client,isAddingIncidentSuccess: null == isAddingIncidentSuccess ? _self.isAddingIncidentSuccess : isAddingIncidentSuccess // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
/// Create a copy of AddIncidentModel
...
class _AddIncidentModel implements AddIncidentModel {
  const _AddIncidentModel({this.decrireAction, this.url, this.county, required this.userLocation, required this.typeCas, required this.degree, required this.client, required this.isAddingIncidentSuccess});
...
@pragma('vm:prefer-inline')
_$AddIncidentModelCopyWith<_AddIncidentModel> get copyWith => __$AddIncidentModelCopyWithImpl<_AddIncidentModel>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AddIncidentModel&&(identical(other.decrireAction, decrireAction) || other.decrireAction == decrireAction)&&(identical(other.url, url) || other.url == url)&&(identical(other.county, county) || other.county == county)&&(identical(other.userLocation, userLocation) || other.userLocation == userLocation)&&(identical(other.typeCas, typeCas) || other.typeCas == typeCas)&&(identical(other.degree, degree) || other.degree == degree)&&(identical(other.client, client) || other.client == client)&&(identical(other.isAddingIncidentSuccess, isAddingIncidentSuccess) || other.isAddingIncidentSuccess == isAddingIncidentSuccess));
}
...
/// @nodoc
abstract mixin class _$AddIncidentModelCopyWith<$Res> implements $AddIncidentModelCopyWith<$Res> {
  factory _$AddIncidentModelCopyWith(_AddIncidentModel value, $Res Function(_AddIncidentModel) _then) = __$AddIncidentModelCopyWithImpl;
@override @useResult
$Res call({
 String? decrireAction, String? url, String? county, UserLocation userLocation, TypeCas typeCas, Degree degree, Client client, bool isAddingIncidentSuccess
});
...
/// @nodoc
class __$AddIncidentModelCopyWithImpl<$Res>
    implements _$AddIncidentModelCopyWith<$Res> {
  __$AddIncidentModelCopyWithImpl(this._self, this._then);

  final _AddIncidentModel _self;
  final $Res Function(_AddIncidentModel) _then;

/// Create a copy of AddIncidentModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? decrireAction = freezed,Object? url = freezed,Object? county = freezed,Object? userLocation = null,Object? typeCas = null,Object? degree = null,Object? client = null,Object? isAddingIncidentSuccess = null,}) {
  return _then(_AddIncidentModel(
decrireAction: freezed == decrireAction ? _self.decrireAction : decrireAction // ignore: cast_nullable_to_non_nullable
as String?,url: freezed == url ? _self.url : url // ignore: cast_nullable_to_non_nullable
as String?,county: freezed == county ? _self.county : county // ignore: cast_nullable_to_non_nullable
as String?,userLocation: null == userLocation ? _self.userLocation : userLocation // ignore: cast_nullable_to_non_nullable
