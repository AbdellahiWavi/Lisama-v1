...
part 'add_incident_response.freezed.dart';
part 'add_incident_response.g.dart';

@freezed
abstract class AddIncidentResponse with _$AddIncidentResponse {
  const factory AddIncidentResponse({
    @JsonKey(name: "id")
    required int id,
  ...
  }) = _AddIncidentResponse;

  factory AddIncidentResponse.fromJson(Map<String, dynamic> json) => _$AddIncidentResponseFromJson(json);
}
