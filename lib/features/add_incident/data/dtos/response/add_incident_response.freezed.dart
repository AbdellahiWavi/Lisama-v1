...
part of 'add_incident_response.dart';
...
@override
String toString() {
  return 'AddIncidentResponse(id: $id, decrireAction: $decrireAction, url: $url, userLocation: $userLocation, county: $county, active: $active, dateCreation: $dateCreation, dateTraitement: $dateTraitement, dernierChEta: $dernierChEta, status: $status, degree: $degree, typeCas: $typeCas, client: $client)';
}
...
/// @nodoc
abstract mixin class $AddIncidentResponseCopyWith<$Res>  {
  factory $AddIncidentResponseCopyWith(AddIncidentResponse value, $Res Function(AddIncidentResponse) _then) = _$AddIncidentResponseCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$AddIncidentResponseCopyWithImpl<$Res>
    implements $AddIncidentResponseCopyWith<$Res> {
  _$AddIncidentResponseCopyWithImpl(this._self, this._then);

  final AddIncidentResponse _self;
  final $Res Function(AddIncidentResponse) _then;
...
class _AddIncidentResponse implements AddIncidentResponse {
  const _AddIncidentResponse({@JsonKey(name: "id") required this.id, @JsonKey(name: "decrireAction") this.decrireAction, @JsonKey(name: "url") this.url, @JsonKey(name: "userLocation") required this.userLocation, @JsonKey(name: "county") required this.county, @JsonKey(name: "active") required this.active, @JsonKey(name: "dateCreation") this.dateCreation, @JsonKey(name: "dateTraitement") this.dateTraitement, @JsonKey(name: "dernierChEta") this.dernierChEta, @JsonKey(name: "status") this.status, @JsonKey(name: "degree") required this.degree, @JsonKey(name: "typeCas") required this.typeCas, @JsonKey(name: "client") required this.client});
  factory _AddIncidentResponse.fromJson(Map<String, dynamic> json) => _$AddIncidentResponseFromJson(json);
...
@pragma('vm:prefer-inline')
_$AddIncidentResponseCopyWith<_AddIncidentResponse> get copyWith => __$AddIncidentResponseCopyWithImpl<_AddIncidentResponse>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AddIncidentResponseToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AddIncidentResponse&&(identical(other.id, id) || other.id == id)&&(identical(other.decrireAction, decrireAction) || other.decrireAction == decrireAction)&&(identical(other.url, url) || other.url == url)&&(identical(other.userLocation, userLocation) || other.userLocation == userLocation)&&(identical(other.county, county) || other.county == county)&&(identical(other.active, active) || other.active == active)&&(identical(other.dateCreation, dateCreation) || other.dateCreation == dateCreation)&&const DeepCollectionEquality().equals(other.dateTraitement, dateTraitement)&&const DeepCollectionEquality().equals(other.dernierChEta, dernierChEta)&&(identical(other.status, status) || other.status == status)&&(identical(other.degree, degree) || other.degree == degree)&&(identical(other.typeCas, typeCas) || other.typeCas == typeCas)&&(identical(other.client, client) || other.client == client));
}
...
/// @nodoc
abstract mixin class _$AddIncidentResponseCopyWith<$Res> implements $AddIncidentResponseCopyWith<$Res> {
  factory _$AddIncidentResponseCopyWith(_AddIncidentResponse value, $Res Function(_AddIncidentResponse) _then) = __$AddIncidentResponseCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: "id") int id,@JsonKey(name: "decrireAction") String? decrireAction,@JsonKey(name: "url") String? url,@JsonKey(name: "userLocation") UserLocation userLocation,@JsonKey(name: "county") String county,@JsonKey(name: "active") bool active,@JsonKey(name: "dateCreation") DateTime? dateCreation,@JsonKey(name: "dateTraitement") dynamic dateTraitement,@JsonKey(name: "dernierChEta") dynamic dernierChEta,@JsonKey(name: "status") String? status,@JsonKey(name: "degree") Degree degree,@JsonKey(name: "typeCas") TypeCas typeCas,@JsonKey(name: "client") Client client
});
...
/// @nodoc
class __$AddIncidentResponseCopyWithImpl<$Res>
    implements _$AddIncidentResponseCopyWith<$Res> {
  __$AddIncidentResponseCopyWithImpl(this._self, this._then);

  final _AddIncidentResponse _self;
  final $Res Function(_AddIncidentResponse) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? decrireAction = freezed,Object? url = freezed,Object? userLocation = null,Object? county = null,Object? active = null,Object? dateCreation = freezed,Object? dateTraitement = freezed,Object? dernierChEta = freezed,Object? status = freezed,Object? degree = null,Object? typeCas = null,Object? client = null,}) {
  return _then(_AddIncidentResponse(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,decrireAction: freezed == decrireAction ? _self.decrireAction : decrireAction // ignore: cast_nullable_to_non_nullable
as String?,url: freezed == url ? _self.url : url // ignore: cast_nullable_to_non_nullable
as String?,userLocation: null == userLocation ? _self.userLocation : userLocation // ignore: cast_nullable_to_non_nullable
