...
@JsonKey(name: "login") String get login;@JsonKey(name: "password") String get password;
...
@useResult
$Res call({
@JsonKey(name: "login") String login,@JsonKey(name: "password") String password
});
...
class _LoginRequest implements LoginRequest {
  const _LoginRequest({@JsonKey(name: "login") required this.login, @JsonKey(name: "password") required this.password});
